...
\begin{tikzpicture}[x=1cm,y=1cm]
 ...
 \draw[dashed] (-.65,0)--(-.65,1.55) node[below=3pt] {$a_2$};
 \draw[dashed] (.45,0)--(.45,.85) node[below=3pt] {$a_1$};
\end{tikzpicture}
...
\begin{tikzpicture}[x=1cm,y=1cm]
 ...
 \fill (0,1) circle (1.3pt) node[below=5pt] {$x_0$};
 \draw[thick,->] (-.14,2.2)--(-.14,1.14);
 \draw[thick] (-.14,1.14) arc[start angle=180,end angle=360,radius=.14];
 \draw[thick,->] (.14,1.14)--(.14,2.05);
\end{tikzpicture}
