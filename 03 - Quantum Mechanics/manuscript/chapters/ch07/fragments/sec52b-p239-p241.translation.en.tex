...
\begin{equation}
 ...
 &=Ze^2\sqrt{\frac m\varepsilon}\operatorname{Im}
 \left\{2q_0v_d-\frac2{\sqrt E}\operatorname{Arch}\sqrt{q_0E}\right\}.
 \end{aligned}
 \tag{3}
\end{equation}
...
\begin{equation}
 ...
 \operatorname{Arch}\sqrt{q_0E_p}\right\}.
 \end{aligned}
 \tag{4}
\end{equation}
...
\begin{equation}
 ...
 \sqrt{\frac2{E_p}}\operatorname{Arch}\sqrt{q_0E_p}
 -\frac2{\sqrt E}\operatorname{Arch}\sqrt{q_0E}\right]\right\}.
 \tag{5}
\end{equation}
In accordance with the origin of the first and second $\operatorname{Arch}$
