...
\SourcePage{244}{247}
Suppose that $E_2>E_1$ on the real axis.
The detour must then lie in the upper half-plane of the complex $t$ plane, since on displacement into this half-plane the ratio $e^{-iE_2t/\hbar}/e^{-iE_1t/\hbar}$ increases.
The result is the formula (analogous to (52.2))
