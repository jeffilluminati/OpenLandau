...
\input{manuscript/chapters/ch10/fragments/sec76-opening.fresh.translation.en.tex}
...
\SourcePage{352}{355}
\ProblemHeading{5.} Calculate the polarizability of an electron in a bound $s$ state in a potential well of range $a$, where $a\kappa\ll1$, $\kappa=\sqrt{2m|E_0|}/\hbar$, and $|E_0|$ is the binding energy.
