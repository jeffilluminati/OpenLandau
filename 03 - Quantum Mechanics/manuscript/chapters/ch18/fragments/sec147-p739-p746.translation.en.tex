...
\foreach \yy/\lab/\leftsign/\rightsign in {12/{a}/1/1,8/{b}/-1/1,4/{c}/-1/-1,0/{d}/1/-1}{
  \draw[->] (0,\yy) -- (5.4,\yy) node[right] {$E$};
  \draw[->] (0,\yy-1.15) -- (0,\yy+1.55) node[above] {$\dfrac{d\sigma}{dE}$};
  \draw[dashed] (2.7,\yy-1.0) -- (2.7,\yy+1.35);
  \ifnum\leftsign=1
    \draw (0.35,\yy+0.15) .. controls (1.45,\yy+0.2) and (2.35,\yy+0.45) .. (2.7,\yy+1.25);
  \else
    \draw (0.35,\yy+1.05) .. controls (1.45,\yy+1.0) and (2.35,\yy+0.75) .. (2.7,\yy-0.05);
  \fi
  \ifnum\rightsign=1
    \draw (2.7,\yy+1.25) .. controls (3.05,\yy+0.45) and (4.15,\yy+0.2) .. (5.05,\yy+0.15);
  \else
    \draw (2.7,\yy-0.05) .. controls (3.05,\yy+0.75) and (4.15,\yy+1.0) .. (5.05,\yy+1.05);
  \fi
...
\begin{tikzpicture}[x=0.95cm,y=0.85cm,line cap=round,line join=round]
 ...
 \draw (0.25,2.65)
  ...
  .. controls (3.43,0.18) and (3.52,2.88) .. (3.7,2.9)
