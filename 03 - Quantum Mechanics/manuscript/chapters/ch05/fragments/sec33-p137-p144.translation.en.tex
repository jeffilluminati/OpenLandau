...
where
\begin{equation}
 R_{kl}''+\frac2rR_{kl}'+[k^2-\frac{l(l+1)}{r^2}]R_{kl}=0.\tag{33.3}
\end{equation}
...
\begin{equation}
 R_{El}=R_{kl}(\frac1{2\pi}\frac{dk}{dE})^{1/2}
...
\SourcePage{139}{142}
Hence
\[\chi_{kl}=(\frac1r\frac d{dr})^l\chi_{k0},\]
where $\chi_{k0}=R_{k0}$ from (33.6), up to an arbitrary constant. Thus
\begin{equation}
 R_{kl}=(-1)^l\,2\frac{r^l}{k^l}(\frac1r\frac d{dr})^l\frac{\sin kr}{r}.
 \tag{33.9}
\end{equation}
...
j_2=(\frac3{x^3}-\frac1x)\sin x-\frac{3\cos x}{x^2}.
\]
...
giving
\begin{equation}R_{kl}\approx\frac2r\sin(kr-\frac{\pi l}2).\tag{33.12}\end{equation}
Normalization may be performed from the asymptotic form (\secref{21}); comparison
with (33.6) confirms the coefficient in (33.9).
\SourcePage{140}{143}
Near the origin, expansion of $\sin kr$ and retention of the term giving the
lowest power after differentiation yields\footnote{$!!$ denotes the product
of all integers of the same parity up to and including the stated one.}
\[
(\frac1r\frac d{dr})^l\frac{\sin kr}r
\approx(\frac1r\frac d{dr})^l\frac{(-1)^l(kr)^{2l+1}}{r(2l+1)!}
=\frac{(-1)^lk^{2l+1}}{(2l+1)!!}.
\]
Therefore
...
For arbitrary $l$,
\begin{equation}
 R_{kl}^\pm=(-1)^lA\frac{r^l}{k^l}(\frac1r\frac d{dr})^l\frac{e^{\pm ikr}}r.
 \tag{33.15}
\end{equation}
...
forms are
\begin{equation}
 R_{kl}^\pm\approx\frac Ar\exp[\pm i(kr-\frac{\pi l}2)],\tag{33.17}
\end{equation}
and near the origin
...
\[J_{l-1/2}(\frac a\hbar\sqrt{2mU_0})=0;\]
