...
\draw[->] (4,1.35)--(4,.65); \draw[->] (2.75,.05)--(2.45,.55); \draw[->] (5.25,.05)--(5.55,.55);
\draw[->] (8,1.15)--(8.65,1.55); \draw[->] (6.75,0)--(6.3,-.45); \draw[->] (9.25,0)--(8.8,.45);
