...
\begin{equation}
 ...
 \tag{121.6}
\end{equation}
here we have used the fact that $Q_{ik}$ is expressed in terms of the nuclear
spin operator by a formula of the type (75.2). Evaluation of the eigenvalues
of (121.6), exactly as in the calculation in Problem 1 of \S~84, gives the
following dependence of the quadrupole hyperfine splitting on $F$:
\begin{equation}
 \frac b2F^2(F+1)^2
