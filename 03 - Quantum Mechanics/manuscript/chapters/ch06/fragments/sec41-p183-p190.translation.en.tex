...
\ProblemHeading{1.} A uniform electric field is suddenly applied to a charged
oscillator in its ground state. Find the probabilities for the perturbation to
transfer the oscillator into its excited states.
\SourcePage{187}{190}
...
\]
Thus the dipole term in the field of the nucleus and the $\alpha$ particle is
\footnote{When the difference $A-2Z$ is small, it may also be necessary to
include the next, quadrupole term.}
\[
