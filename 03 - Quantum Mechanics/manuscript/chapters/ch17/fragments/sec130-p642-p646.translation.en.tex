...
The concept of a scattering amplitude involves only the directions of the
initial and final momenta of the scattered particle. It is therefore natural
that this concept can also be

\SourcePage{643}{646}
reached by formulating the scattering problem in the momentum representation,
where the spatial distribution of the entire process is not considered at
all. We shall show how this is done.
...
\begin{tikzpicture}[x=1cm,y=1cm,>=stealth,line width=.5pt,font=\small]
 ...
 \begin{scope}[shift={(2.3,0)}]
  ...
  \draw[->] (.2,.55) arc[start angle=90,end angle=-270,radius=.28];
  \node[below] at (0,-.55) {(b)};
 \end{scope}
\end{tikzpicture}
\caption{}
