...
\SourcePage{621}{624}
Thus scattering with momentum change $\hbar\mathbf q$ is determined by the
squared modulus of the corresponding Fourier component of $U$. Formula
(126.7) was first obtained by \emph{Born} (M.~Born, 1926); this approximation
in collision theory is commonly called the \emph{Born approximation}.
