...
\begin{tikzpicture}[x=1.05cm,y=.78cm,>=stealth,line cap=round,line join=round]
  ...
  \draw[thick] (-3.4,1.75)--(0,1.75)
    .. controls (1.45,1.75) and (1.45,-1.75) .. (0,-1.75)
    --(-3.4,-1.75);
  \draw[->,thick] (1.25,-.38)--(1.30,.20);
  \draw[->,thick] (-1.9,1.75)--(-2.6,1.75);
  \draw[->,thick] (-1.5,1.48)--(-2.2,1.48);
  \draw[thick] (-3.4,1.48)--(0,1.48)
    .. controls (.45,1.48) and (.45,.84) .. (0,.84)
    --(-3.4,.84);
  \draw[->,thick] (-2.6,.84)--(-1.9,.84);
  \draw[thick] (-3.4,-.84)--(0,-.84)
    .. controls (.45,-.84) and (.45,-1.48) .. (0,-1.48)
    --(-3.4,-1.48);
  \draw[->,thick] (-1.9,-.84)--(-2.6,-.84);
  \draw[->,thick] (-2.6,-1.48)--(-1.9,-1.48);
  \node[right] at (1.42,-.28) {$C$};
  \node[right] at (.4,1.16) {$C_2$};
  \node[right] at (.4,-1.16) {$C_1$};
\end{tikzpicture}
...
\begin{tikzpicture}[x=1.1cm,y=1cm,>=stealth,line cap=round,line join=round]
  ...
  \fill (-1.05,0) circle (1.5pt) node[above right] {$t=0$};
